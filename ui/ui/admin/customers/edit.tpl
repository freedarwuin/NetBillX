                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" id="service_type" name="service_type">
                                ...
                                <option value="Otro" {if $d['service_type'] eq 'Otro' }selected{/if}>{Lang::T("Other")}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" id="account_type" name="account_type">
                                ...
                                <option value="Negocio" {if $d['account_type'] eq 'Negocio' }selected{/if}>{Lang::T("Business")}
                                </option>
                            </select>
                        </div>
                    </div>
