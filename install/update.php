    ...
    <div id='main-container'>
        ...
        <div class="span12">
            ...
            try{
                ...
                /* ✅ INSERTAR VALOR INICIAL SI ESTÁ VACÍA */
                $count = $dbh->query("SELECT COUNT(*) FROM bcv_rate")->fetchColumn();
                if ($count == 0) {
                    echo "INSERTANDO VALOR INICIAL EN BCV_RATE...\n\n";
                    $dbh->exec("INSERT INTO bcv_rate (rate) VALUES (36.50)");
                }

                /* ✅ TABLAS ORIGINALES */
                echo "CREATE TABLE `tbl_payment_gateway` (...)\n\n";
                $dbh->exec("CREATE TABLE `tbl_payment_gateway` (
                    `id` int(11) NOT NULL,
                ...
                /* ✅ RESTO DE TUS ALTER TABLE */
                echo "ALTER TABLE `tbl_customers` ADD `email` VARCHAR(128) NOT NULL DEFAULT '' AFTER `phonenumber`;\n\n";
                $dbh->exec("ALTER TABLE `tbl_customers` ADD `email` VARCHAR(128) NOT NULL DEFAULT '' AFTER `phonenumber`;");
