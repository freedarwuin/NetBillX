            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="https://github.com/freedarwuin/NetBillX/discussions" target="_blank"
                        ...
                        Discussions')}</a>
                    <a href="https://t.me/freedarwuin" target="_blank" class="btn btn-primary btn-sm btn-block"><i
...
<div class="row">
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <a href="https://t.me/freedarwuin" target="_blank" class="btn btn-primary btn-sm btn-block">{Lang::T('Telegram')}</a>
            </div>
        </div>
        ...
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-body">
                ...
                {Lang::T('is a Hotspot and PPPoE billing platform for Mikrotik developed using PHP. The application uses Mikrotik API to communicate with the router, ensuring efficient and easy integration. If you feel you get more benefits from this application, we would greatly appreciate your contribution through donation.')}<br>{Lang::T('Watch project –')} <a
                    href="https://github.com/freedarwuin/01-NetBillXyz" target="_blank">{Lang::T('IN HERE')}</a>
            </div>
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <a href="https://github.com/freedarwuin/01-NetBillXyz/archive/refs/heads/master.zip" target="_blank"
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <a href="https://github.com/freedarwuin/01-NetBillXyz/blob/master/CHANGELOG.md" target="_blank"
