            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" role="form" action="{Text::url('')}plan/voucher-post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select name="voucher_format" id="voucher_format" class="form-control">
                                ...
                                <option value="up" {if $_c['voucher_format']=='up' }selected="selected" {/if}>MAYÚSCULAS
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="prefix" placeholder="Net-"
                                value="{$_c['voucher_prefix']}">
                        </div>
                        <p class="help-block col-md-4">Net-VoUCHeRCOdE</p>
                    </div>
                    <div class="form-group">
