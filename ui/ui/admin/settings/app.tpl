        ...
        <div id="collapseGeneral" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a href="https://github.com/freedarwuin/NetBillX/wiki/Themes"
        ...
        <div id="collapseVoucher" class="panel-collapse collapse" role="tabpanel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4">{Lang::T('UPPERCASE')} {Lang::T('lowercase')} {Lang::T('Random')}</p>
                </div>
                {if $_c['disable_voucher'] != 'yes'}
                    <div class="form-group">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a
                            href="https://github.com/freedarwuin/NetBillX/wiki/FreeRadius"
        ...
        <div id="collapseEmailNotification" class="panel-collapse collapse" role="tabpanel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4">MAYÚSCULAS minúsculas Aleatorio</p>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="github_username" name="github_username"
                                value="{$_c['github_username']}" placeholder="freedarwuin">
                        </div>
                    </div>
                </div>
                <div class="form-group">
