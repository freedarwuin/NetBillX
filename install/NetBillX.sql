...
(7, 3, 3, 'Admin', 1, 'Cron Monitor', 'cron_monitor', ''),
(8, 4, 3, 'Admin', 1, 'Mikrotik Cron Monitor', 'mikrotik_cron_monitor', ''),
(9, 5, 3, 'Admin', 1, 'Info Payment Gateway', 'info_payment_gateway', ''),
(10, 6, 3, 'Admin', 1, 'Graph Customers Insight', 'graph_customers_insight', ''),
(11, 8, 3, 'Admin', 1, 'Activity Log', 'activity_log', ''),
(12, 1, 3, 'Admin', 1, 'Update Binance', 'update_binance', ''),
(13, 1, 2, 'Admin', 1, 'Update Bcv', 'update_bcv', ''),

(14, 1, 1, 'Agent', 1, 'Top Widget', 'top_widget', ''),
(15, 2, 1, 'Agent', 1, 'Default Info', 'default_info_row', ''),
(16, 1, 2, 'Agent', 1, 'Graph Monthly Registered Customers', 'graph_monthly_registered_customers', ''),
(17, 2, 2, 'Agent', 1, 'Graph Monthly Sales', 'graph_monthly_sales', ''),
(18, 3, 2, 'Agent', 1, 'Voucher Stocks', 'voucher_stocks', ''),
(19, 4, 2, 'Agent', 1, 'Customer Expired', 'customer_expired', ''),
(20, 1, 3, 'Agent', 1, 'Cron Monitor', 'cron_monitor', ''),
(21, 2, 3, 'Agent', 1, 'Mikrotik Cron Monitor', 'mikrotik_cron_monitor', ''),
(22, 3, 3, 'Agent', 1, 'Info Payment Gateway', 'info_payment_gateway', ''),
(23, 4, 3, 'Agent', 1, 'Graph Customers Insight', 'graph_customers_insight', ''),
(24, 5, 3, 'Agent', 1, 'Activity Log', 'activity_log', ''),

(25, 1, 1, 'Sales', 1, 'Top Widget', 'top_widget', ''),
(26, 2, 1, 'Sales', 1, 'Default Info', 'default_info_row', ''),
(27, 1, 2, 'Sales', 1, 'Graph Monthly Registered Customers', 'graph_monthly_registered_customers', ''),
(28, 2, 2, 'Sales', 1, 'Graph Monthly Sales', 'graph_monthly_sales', ''),
(29, 3, 2, 'Sales', 1, 'Voucher Stocks', 'voucher_stocks', ''),
(30, 4, 2, 'Sales', 1, 'Customer Expired', 'customer_expired', ''),
(31, 1, 3, 'Sales', 1, 'Cron Monitor', 'cron_monitor', ''),
(32, 2, 3, 'Sales', 1, 'Mikrotik Cron Monitor', 'mikrotik_cron_monitor', ''),
(33, 3, 3, 'Sales', 1, 'Info Payment Gateway', 'info_payment_gateway', ''),
(34, 4, 3, 'Sales', 1, 'Graph Customers Insight', 'graph_customers_insight', ''),
(35, 5, 3, 'Sales', 1, 'Activity Log', 'activity_log', ''),

(36, 1, 2, 'Customer', 1, 'Account Info', 'account_info', ''),
(37, 3, 1, 'Customer', 1, 'Active Internet Plan', 'active_internet_plan', ''),
(38, 4, 1, 'Customer', 1, 'Balance Transfer', 'balance_transfer', ''),
(39, 1, 1, 'Customer', 1, 'Unpaid Order', 'unpaid_order', ''),
(40, 2, 1, 'Customer', 1, 'Announcement', 'announcement', ''),
(41, 5, 1, 'Customer', 1, 'Recharge A Friend', 'recharge_a_friend', ''),
(42, 2, 2, 'Customer', 1, 'Voucher Activation', 'voucher_activation', ''),
(43, 3, 2, 'Customer', 1, 'Update Bcv', 'update_bcv', '');