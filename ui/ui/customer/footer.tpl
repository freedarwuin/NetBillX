...
{else}
    <footer class="main-footer">
        NetBillX by <a href="https://github.com/freedarwuin/NetBillX" rel="nofollow noreferrer noopener"
            target="_blank">freedarwuin</a>, Theme by <a href="https://adminlte.io/" rel="nofollow noreferrer noopener"
