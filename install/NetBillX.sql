...
(1, 1, 1, 'Admin', 1, 'Top Widget', 'top_widget', '<p>Barra pricipal</p>'),
(2, 1, 2, 'Admin', 1, 'Default Info Row', 'default_info_row', ''),
(3, 1, 3, 'Admin', 1, 'Info Payment Gateway', 'info_payment_gateway', ''),
(4, 1, 4, 'Admin', 1, 'Cron Monitor', 'cron_monitor', ''),
(5, 1, 5, 'Admin', 1, 'Graph Monthly Registered Customers', 'graph_monthly_registered_customers', ''),
(6, 1, 6, 'Admin', 1, 'Graph Monthly Sales', 'graph_monthly_sales', ''),
(7, 1, 7, 'Admin', 1, 'Update Bcv', 'update_bcv', ''),
(8, 1, 8, 'Admin', 1, 'Update Binance', 'update_binance', ''),
(9, 1, 10, 'Admin', 1, 'Customer Expired', 'customer_expired', ''),
(10, 1, 9, 'Admin', 1, 'Graph Customers Insight', 'graph_customers_insight', ''),
(11, 2, 9, 'Admin', 1, 'Activity Log', 'activity_log', ''),
(12, 1, 12, 'Admin', 1, 'Voucher Stocks', 'voucher_stocks', ''),
