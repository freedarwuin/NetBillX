    ...
    <div class="panel-heading">
        {if in_array($_admin['user_type'],['SuperAdmin','Admin'])}
            <div class="btn-group pull-right">
                <a class="btn btn-danger btn-xs" title="Eliminar cupón usado" href="{Text::url('')}plan/remove-voucher"
                    onclick="return ask(this, '¿Eliminar todos los códigos de cupón utilizados durante más de 3 meses?')"><span
