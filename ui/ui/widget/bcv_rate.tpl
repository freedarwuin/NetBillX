...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Colores de líneas
    const bcvColor = '#007bff';
    const usdtColor = '#28a745';
            ...
            datasets: [
                {
                    ...
                    backgroundColor: bcvColor + '20',
                    borderWidth: 3,
                    tension: 0.4,
                    fill: true,
                    pointRadius: 3,
                    pointBackgroundColor: bcvColor
                },
                {
                    label: 'USDT',
                    data: usdtData,
                    borderColor: usdtColor,
                    backgroundColor: usdtColor + '20',
                    borderWidth: 3,
                    tension: 0.4,
                    fill: true,
                    pointRadius: 3,
                    pointBackgroundColor: usdtColor
                }
            ]
        },
        options: {
