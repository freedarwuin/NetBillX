        ...
        <div class="panel-heading">
            ...
            <div class="btn-group pull-right">
                <a class="btn btn-warning btn-xs" title="info"
                    href="https://github.com/freedarwuin/NetBillX/wiki/Installing-Plugin-or-Payment-Gateway"
                            ...
                            <div class="box-footer">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <a href="{$plugin['github']}" target="_blank" style="color: black;"
                                        class="btn btn-info"><i class="glyphicon glyphicon-align-left"></i> {Lang::T('Source')}</a>
                                </div>
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
